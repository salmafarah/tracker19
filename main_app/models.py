...
Companions = (
    ('choice2', 'Family Member'),
    ('choice2', 'Friend(s)'),
    ('choice3', 'Roommate'),
    ('choice4', 'Significant Other'),
    ('choice5', 'Other')
)
...
class Partner(models.Model):
    name = models.CharField('Who are you travelling with?', choices= Companions, max_length=30)
...
class Partner(models.Model): 
    name = models.CharField('Who did you travel with?',choices= Companions, max_length=100)
